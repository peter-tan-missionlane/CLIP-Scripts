...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.2  THEN 100
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.2  THEN 100
...
WHEN PRE_CLIP_LINE_LIMIT > 0 AND PRE_CLIP_LINE_LIMIT <= 1000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.2  THEN 100
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT > 0 AND average_utilization_3_months_FLOAT < 0.1 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1  THEN 500
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 1000 AND PRE_CLIP_LINE_LIMIT <= 2000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 2000 AND PRE_CLIP_LINE_LIMIT <= 3000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1  THEN 500
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1  THEN 500
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1  THEN 500
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 0.52  THEN 1000
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.2 AND ab_testing_random_number_FLOAT < 1  THEN 500
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT >= 0.02 AND ab_testing_random_number_FLOAT < 1  THEN 500
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.3 AND average_utilization_3_months_FLOAT < 0.5 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 0
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0.52 AND ab_testing_random_number_FLOAT <= 1  THEN 1500
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 3 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.2  THEN 100
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 4 AND average_utilization_3_months_FLOAT >= 0.1 AND average_utilization_3_months_FLOAT < 0.3 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.2  THEN 100
...
WHEN PRE_CLIP_LINE_LIMIT > 3000 AND PRE_CLIP_LINE_LIMIT <= 5000 AND RISKGROUP_DSERIES_Y1 = 5 AND average_utilization_3_months_FLOAT >= 0.5 AND average_utilization_3_months_FLOAT < 0.8 AND ab_testing_random_number_FLOAT >= 0 AND ab_testing_random_number_FLOAT <= 0.2  THEN 100
...
,case when util_band ilike '%1%' then '1:<=0%'
    ...
    , TEST_CLIP_AMOUNT
    , case when D_SERIES_CLIP_AMOUNT > 100 then 1 else 0 end as D_CLIP_CNT
    ,potential_credit_lines_max
FROM    CLIP_FINAL   
