...
WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.0 AND average_utilization_3_months_FLOAT <=  0.1 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
 ...
 WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
 ...
 WHEN clip_risk_group_INT = 4 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 THEN 1000  
...
--        decision_data,
        ...
        CASE 
            ...
            WHEN   clip_risk_group_INT = 10 AND  average_utilization_3_months_FLOAT <0.1 AND  average_purchase_utilization_3_months >=0.1 AND  ab_testing_random_number_FLOAT >= 0.05 THEN 100
             ...
             WHEN clip_risk_group_INT = 10 AND average_utilization_3_months_FLOAT >  0.0 AND average_utilization_3_months_FLOAT <=  0.1 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             ...
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 6 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 7 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 8 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 9 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 10 AND average_utilization_3_months_FLOAT >  0.1 AND average_utilization_3_months_FLOAT <=  0.3 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             ...
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 6 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 7 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 8 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 9 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 10 AND average_utilization_3_months_FLOAT >  0.3 AND average_utilization_3_months_FLOAT <=  0.5 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 4 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             ...
             WHEN clip_risk_group_INT = 6 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 6 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 6 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 7 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 8 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 9 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 10 AND average_utilization_3_months_FLOAT >  0.5 AND average_utilization_3_months_FLOAT <=  0.8 AND ab_testing_random_number_FLOAT >= -0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 1 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 2 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 3 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 4 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 4 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 4 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 1000 <= potential_credit_lines_max) THEN 1000  
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 500 <= potential_credit_lines_max) THEN 500  
             WHEN clip_risk_group_INT = 5 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 500 <= potential_credit_lines_max) THEN 500  
             WHEN clip_risk_group_INT = 6 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             ...
             WHEN clip_risk_group_INT = 7 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 0.05 THEN 100  
             WHEN clip_risk_group_INT = 7 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.05 AND ab_testing_random_number_FLOAT < 0.8 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 7 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.8 AND ab_testing_random_number_FLOAT < 1.0 AND (PRE_CLIP_LINE_LIMIT + 300 <= potential_credit_lines_max) THEN 300  
             WHEN clip_risk_group_INT = 8 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 9 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
             WHEN clip_risk_group_INT = 10 AND average_utilization_3_months_FLOAT >  0.8 AND ab_testing_random_number_FLOAT >= 0.0 AND ab_testing_random_number_FLOAT < 1.0 THEN 100  
